...
import { FileText, FileCheck, FileSignature, Trash2, Plus } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">모든 프로젝트의 문서를 관리합니다</p>
        </div>
        <Button
      ...
      {loading ? (
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-16">
            ...
            <p className="text-gray-500 mb-2">문서가 없습니다</p>
            <p className="text-sm text-gray-400 mb-4">새 문서를 작성해보세요</p>
      ...
      {/* 프로젝트 선택 다이얼로그 */}
      {showProjectSelect && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50" onClick={() => setShowProjectSelect(false)}>
          <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-md mx-4" onClick={(e) => e.stopPropagation()}>
            <h3 className="text-lg font-semibold text-gray-900 mb-2">프로젝트 선택</h3>
            <p className="text-sm text-gray-500 mb-4">문서를 생성할 프로젝트를 선택하세요</p>
            ...
            <Button variant="ghost" className="mt-4 w-full" onClick={() => setShowProjectSelect(false)}>
              취소
            </Button>
          </div>
        </div>
